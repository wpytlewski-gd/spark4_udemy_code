...
accessLines = spark.readStream.text("Materials/Code/logs")
...
endpointCounts = logsDF.groupBy(
    func.window(func.col("eventTime"), "30 seconds", "10 seconds"), func.col("endpoint")
).count()

endpointCounts.orderBy(func.col("count").desc())
